...
def directory_loop(directory,kws, title_search, author_search, translator_search, illustrator_search):
...
def main():
    directory_loop(directory,kws, title_search, author_search, translator_search, illustrator_search)
